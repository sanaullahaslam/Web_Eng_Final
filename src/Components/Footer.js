    ...
    return (
        <div className="bg-dark text-center footer-landing">
            ...
            <div className="row mt-5">
                ...
                <div className="col-4 text-white text-end me-2">
                    <p>
                        <a className="text-white font-bold-light" target="_blank" href="https://www.instagram.com/web3makr/">
                            <svg className="bi bi-instagram" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12 2a5 5 0 0 0-5 5 5 5 0 0 0 10 0A5 5 0 0 0 12 2zm-1.75 8.268a7.002 7.002 0 0 0 3.482-6.016 7 7 0 1 0-14 0 7.002 7.002 0 0 0 3.482 6.016 9 9 0 1 1 7.036 0zM8 9a3 3 0 1 0 0-6 3 3 0 0 0 0 6z" />
                            </svg>
                        </a>
                        <a className="text-white font-bold-light" href="#">
