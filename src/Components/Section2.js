      ...
      <div className="container">
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12 col-md-12">
            ...
            <p class="font-bold-light" style={{ fontSize: "25px", textAlign: "start" }}>
            ...
            <a href="https://web3makr.netlify.app/">
              <button class="btn font-bold-light btn-lg" style={{ backgroundColor: "rgb(111, 52, 142)", color: "white" }}>Start Building</button>
            </a>
          </div>
          <div className="col-lg-6 col-sm-12 col-md-12">
        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 col-sm-12">
            <div class="col-sm-12 my-4 col-md-6 col-lg-6 col-xl-6">
              ...
              <br />
              <a href="https://web3makr.netlify.app/">
                <button class="btn mt-4 font-bold-light btn-sm" style={{ backgroundColor: "rgb(111, 52, 142)", color: "white" }}>
                  Start Building
                </button>
              </a>
            </div>
